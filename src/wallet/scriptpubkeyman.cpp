...
std::optional<PSBTError> DescriptorScriptPubKeyMan::FillPSBT(PartiallySignedTransaction& psbtx, const PrecomputedTransactionData& txdata, common::PSBTOptions options, int* n_signed) const
{
    if (n_signed) {
        *n_signed = 0;
    }
