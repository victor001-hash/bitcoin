...
extern const std::string LAST_DECRYPTED_VERSION;
...
public:
    ...
    // Write the current version as the last version to decrypt the keys in this wallet file
    bool WriteLastDecryptedVersion();
